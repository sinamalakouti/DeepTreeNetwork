...
//  made by sina 
  ...
  public double[] predicate(Instance instance , boolean isOutputLayer) throws Exception{
	 
	  return m_root.predicate(instance, isOutputLayer);

  }
  
  public double[] predicateDerivative( Instance instance , boolean isOutputLayerActivation) throws Exception {
	  return m_root.predicateDerviativ(instance, isOutputLayerActivation);
  }
