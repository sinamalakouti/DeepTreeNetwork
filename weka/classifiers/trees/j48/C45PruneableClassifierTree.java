 ...
 * @throws Exception 
   */
  public final void collapse() throws Exception{
...
//			// pca.buildEvaluator(tempInstances[c]);
//			// covMatirx[c] = new Matrix(pca.getCorrelationMatrix());
...
//					} else {
//						try {
//						mu[i][c] = tempInstances[c].meanOrMode(i);
//						}catch (Exception e) {
...
//						}
//						sd[i][c] = tempInstances[c].attributeStats(i).numericStats.stdDev + 0.1;
//						
//					}
//					
//					if ( Double.isNaN(sd[i][c]) || sd[i][c] < 0 ) {
...
//	}
  protected ClassifierTree getNewTree(Instances data, int depth) throws Exception {
    ...
    super.numInstances = numInstances;
//    if ( newTree.isLeaf() && mu == null)
