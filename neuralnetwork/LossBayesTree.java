 ...
 */
public class LossBayesTree extends DifferentialFunction implements ILossFunction {
     ...
     * @param weights Weights array (row vector). May be null.
     */
    public LossBayesTree(@JsonProperty("softmaxClipEps") double softmaxClipEps, @JsonProperty("weights") INDArray weights) {
